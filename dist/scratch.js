 ...
 */
var ScratchDB = /** @class */ (function (_super) {
    __extends(ScratchDB, _super);
     ...
     */
    ScratchDB.prototype.get = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var value, error_1, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._leveldb.get(key, db_1.ENCODING_OPTS)];
                    case 2:
                        value = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        if (!(!value && this._upstream._leveldb)) return [3 /*break*/, 8];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, this._upstream._leveldb.get(key, db_1.ENCODING_OPTS)];
                    case 6:
                        value = _a.sent();
                        return [3 /*break*/, 8];
                    case 7:
    ...
    ScratchDB.prototype.copy = function () {
