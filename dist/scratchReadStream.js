 ...
 */
var ScratchReadStream = /** @class */ (function (_super) {
    __extends(ScratchReadStream, _super);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._started = true;
                        return [4 /*yield*/, this.trie._findDbNodes(function (nodeRef, node, key, walkController) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            this.push({
